...
from VRProblemDef import get_random_problems_VRPB, augment_xy_data_by_8_fold
...
class VRPEnv:
    ...
    def load_problems(self, batch_size, aug_factor=1):
        ...
        if not self.FLAG__use_saved_problems:
            ...
            depot_xy, node_xy, node_demand = get_random_problems_VRPB(batch_size, self.problem_size)
        else:
